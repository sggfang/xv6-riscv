...
main(int argc, char **argv)
{
  ...
  34:	256080e7          	jalr	598(ra) # 286 <kill>
  for(i=1; i<argc; i++)
  38:	04a1                	addi	s1,s1,8
  3a:	ff2496e3          	bne	s1,s2,26 <main+0x26>
  exit();
  3e:	00000097          	auipc	ra,0x0
  42:	218080e7          	jalr	536(ra) # 256 <exit>
    fprintf(2, "usage: kill pid...\n");
  46:	00000597          	auipc	a1,0x0
  4a:	74a58593          	addi	a1,a1,1866 # 790 <malloc+0xe4>
  4e:	4509                	li	a0,2
  50:	00000097          	auipc	ra,0x0
  54:	570080e7          	jalr	1392(ra) # 5c0 <fprintf>
    exit();
  58:	00000097          	auipc	ra,0x0
  5c:	1fe080e7          	jalr	510(ra) # 256 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35e:	45650513          	addi	a0,a0,1110 # 7b0 <digits>
 362:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 42a:	38ab8b93          	addi	s7,s7,906 # 7b0 <digits>
 ...
 56a:	24290913          	addi	s2,s2,578 # 7a8 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 632:	19a7b783          	ld	a5,410(a5) # 7c8 <freep>
 ...
 660:	00e6ea63          	bltu	a3,a4,674 <free+0x50>
{
 ...
 6a2:	12f73523          	sd	a5,298(a4) # 7c8 <freep>
}
 6a6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6d4:	0f853503          	ld	a0,248(a0) # 7c8 <freep>
 ...
 6fc:	0d090913          	addi	s2,s2,208 # 7c8 <freep>
  if(p == (char*)-1)
 700:	5afd                	li	s5,-1
 702:	a88d                	j	774 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 704:	00000797          	auipc	a5,0x0
 708:	0cc78793          	addi	a5,a5,204 # 7d0 <base>
 70c:	00000717          	auipc	a4,0x0
 710:	0af73e23          	sd	a5,188(a4) # 7c8 <freep>
 714:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 736:	08a73b23          	sd	a0,150(a4) # 7c8 <freep>
      return (void*)(p + 1);
