...
free(void *ap)
{
 ...
 6b2:	1ea7b783          	ld	a5,490(a5) # 898 <__SDATA_BEGIN__>
 ...
 6e0:	00e6ea63          	bltu	a3,a4,6f4 <free+0x50>
{
 ...
 722:	16f73d23          	sd	a5,378(a4) # 898 <__SDATA_BEGIN__>
}
 726:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 754:	14853503          	ld	a0,328(a0) # 898 <__SDATA_BEGIN__>
 ...
 77c:	12090913          	addi	s2,s2,288 # 898 <__SDATA_BEGIN__>
  if(p == (char*)-1)
 780:	5afd                	li	s5,-1
 ...
 790:	10f73623          	sd	a5,268(a4) # 898 <__SDATA_BEGIN__>
 794:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b6:	0ea73323          	sd	a0,230(a4) # 898 <__SDATA_BEGIN__>
      return (void*)(p + 1);
