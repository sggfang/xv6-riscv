...
000000000000011a <grep>:
{
 ...
 162:	35a080e7          	jalr	858(ra) # 4b8 <write>
      p = q+1;
 ...
 172:	1cc080e7          	jalr	460(ra) # 33a <strchr>
 176:	84aa                	mv	s1,a0
 ...
 1a0:	314080e7          	jalr	788(ra) # 4b0 <read>
 ...
 1ca:	29c080e7          	jalr	668(ra) # 462 <memmove>
...
00000000000001ea <main>:
{
 ...
 202:	0085ba03          	ld	s4,8(a1)
  if(argc <= 2){
 206:	4789                	li	a5,2
 208:	06a7d563          	bge	a5,a0,272 <main+0x88>
 ...
 22a:	2b2080e7          	jalr	690(ra) # 4d8 <open>
 22e:	84aa                	mv	s1,a0
 230:	04054b63          	bltz	a0,286 <main+0x9c>
    grep(pattern, fd);
 234:	85aa                	mv	a1,a0
 236:	8552                	mv	a0,s4
 ...
 246:	27e080e7          	jalr	638(ra) # 4c0 <close>
  for(i = 2; i < argc; i++){
 24a:	0921                	addi	s2,s2,8
 24c:	fd391ae3          	bne	s2,s3,220 <main+0x36>
  exit();
 250:	00000097          	auipc	ra,0x0
 254:	248080e7          	jalr	584(ra) # 498 <exit>
    fprintf(2, "usage: grep pattern [file ...]\n");
 258:	00000597          	auipc	a1,0x0
 25c:	78058593          	addi	a1,a1,1920 # 9d8 <malloc+0xea>
 260:	4509                	li	a0,2
 262:	00000097          	auipc	ra,0x0
 266:	5a0080e7          	jalr	1440(ra) # 802 <fprintf>
    exit();
 26a:	00000097          	auipc	ra,0x0
 26e:	22e080e7          	jalr	558(ra) # 498 <exit>
    grep(pattern, 0);
 272:	4581                	li	a1,0
 274:	8552                	mv	a0,s4
 276:	00000097          	auipc	ra,0x0
 27a:	ea4080e7          	jalr	-348(ra) # 11a <grep>
    exit();
 27e:	00000097          	auipc	ra,0x0
 282:	21a080e7          	jalr	538(ra) # 498 <exit>
      printf("grep: cannot open %s\n", argv[i]);
 286:	00093583          	ld	a1,0(s2)
 28a:	00000517          	auipc	a0,0x0
 28e:	76e50513          	addi	a0,a0,1902 # 9f8 <malloc+0x10a>
 292:	00000097          	auipc	ra,0x0
 296:	59e080e7          	jalr	1438(ra) # 830 <printf>
      exit();
 29a:	00000097          	auipc	ra,0x0
 29e:	1fe080e7          	jalr	510(ra) # 498 <exit>
...
memset(void *dst, int c, uint n)
{
 ...
 318:	0800                	addi	s0,sp,16
  ...
  int i;
  for(i = 0; i < n; i++){
 31a:	ce09                	beqz	a2,334 <memset+0x20>
 31c:	87aa                	mv	a5,a0
 31e:	fff6071b          	addiw	a4,a2,-1
 322:	1702                	slli	a4,a4,0x20
 324:	9301                	srli	a4,a4,0x20
 326:	0705                	addi	a4,a4,1
 328:	972a                	add	a4,a4,a0
    cdst[i] = c;
 32a:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
 32e:	0785                	addi	a5,a5,1
 330:	fee79de3          	bne	a5,a4,32a <memset+0x16>
  }
  return dst;
}
 334:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
 ...
 394:	120080e7          	jalr	288(ra) # 4b0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3e6:	0f6080e7          	jalr	246(ra) # 4d8 <open>
  if(fd < 0)
 ...
 3f6:	0fe080e7          	jalr	254(ra) # 4f0 <fstat>
 3fa:	892a                	mv	s2,a0
  close(fd);
 3fc:	8526                	mv	a0,s1
 3fe:	00000097          	auipc	ra,0x0
 402:	0c2080e7          	jalr	194(ra) # 4c0 <close>
  return r;
}
 406:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 466:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  while(n-- > 0)
 468:	02c05163          	blez	a2,48a <memmove+0x28>
...
putc(int fd, char c)
{
 ...
 56e:	f4e080e7          	jalr	-178(ra) # 4b8 <write>
}
...
malloc(uint nbytes)
{
 ...
 9c6:	b5e080e7          	jalr	-1186(ra) # 520 <sbrk>
  if(p == (char*)-1)
